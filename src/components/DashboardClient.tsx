      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div
            ...
            onClick={() => nevigate.push("/")}
          >
            Support <span className="text-zinc-400">AI</span>
          </div>
          <button className="px-4 py-2 rounded-lg border border-zinc-300 text-sm hover:bg-zinc-100 transition cursor-pointer" onClick={()=>nevigate.push("/embed")}>
            Embed ChatBot
          </button>
        </div>
      </motion.div>
          ...
          <div className="mb-10">
            ...
            <div className="space-y-4">
              <textarea
                ...
                placeholder={`Example:
1. Refund policy: 7 days return available
2. Delivery time: 3-5 working days
...
4. Support hours
          ...
          <div className="flex items-center gap-5">
            <motion.button
              ...
              className="cursor-pointer px-7 py-3 rounded-xl bg-black text-white text-sm font-medium hover:bg-zinc-800 transition disabled:opacity-60"
            >
              {loading ? "Saving..." : "Save"}
            </motion.button>
