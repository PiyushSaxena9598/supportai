...
function HomeClient({ email }: { email: string }) {
  ...
  const features = [
    {
      title: "Plug & Play",
      desc: "Get started in minutes with our easy-to-use setup. No coding required, just plug in and go!",
    },
    {
      title: "Admin Controlled",
      desc: "You can control exactly what the AI knows and answers",
    },
    {
      title: "Always Online",
      desc: "Your AI assistant is available 24/7, no matter the time or place.",
    },
  ];
    ...
    <div className="min-h-screen bg-linear-to-br from-white to-zinc-50 text-zinc-900 overflow-x-hidden">
                ...
                {open && (
                  ...
                  >
                    <button
                      ...
                      onClick={() => nevigate.push("/dashboard")}
                    >
                      Dashboard
                    </button>
                    <button
                      className="block px-4 py-3 text-sm text-red-600 hover:bg-zinc-100 cursor-pointer"
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            Why Bysinesses choose Suppert AI?
          </motion.h2>
      ...
      <footer className="py-10 text-center text-sm text-zinc-500">
        &copy; {new Date().getFullYear()} Suppert AI. All rights reserved.
      </footer>
    </div>
  );
}
